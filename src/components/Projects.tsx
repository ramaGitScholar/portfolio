export default function Projects(){
    return (
        <section id="projects" className="bg-[#091E2B] h-180 z-0 flex justify-center items-center">
            <div className="text-center flex flex-col justify-center items-center px-16">
                <h1 className="text-white text-4xl font-poppins font-semibold text-right">PROJECTS</h1>
